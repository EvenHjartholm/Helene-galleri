...
async function testUrls() {
  const filename = '1767583747584-local-upload.jpg'; // The 115MB file
  
  const renderUrl = `${supabaseUrl}/storage/v1/render/image/public/Helene-gallery-image/${filename}?width=480&quality=70`;
